...
export const MultiStepForm = () => {
  ...
  // Função validar etapa antes de avançar
  ...
  if (isSuccess) {
    return (
      <div className="bg-[#1DEA4C] border-7 h-105 p-5 rounded-[20px] text-center text-[#202020] flex flex-col items-center gap-5 mx-auto shadow-2xl animate-in zoom-in bg-cover bg-top bg-no-repeat flex flex-col justify-center lg:p-15 lg:justify-end lg:pb-15" style={{ backgroundImage: "url('https://res.cloudinary.com/dbgkgdeex/image/upload/v1773153039/BGpopup_kprljq.png')"}}>
        <div>
        ...
        {step === 2 && (
          <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-right-4 ">
            ...
            <div className="flex gap-3">
              ...
              <button type="button" onClick={() => handleNextStep(["services"])} className="flex-1 border-2 border-[#1DEA4C] text-[#F2F9FF] p-4 rounded-2xl font-black hover:bg-[#1DEA4C] hover:text-[#202020]">AVANÇAR</button>
            </div>
          </div>
        )}
