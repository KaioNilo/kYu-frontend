      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-full h-full flex flex-col justify-between">
        ...
        {step === 1 && (
          <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-right-4 w-[382px] mx-auto">
            ...
            <div className="flex flex-col gap-1">
              <label className="flex items-center gap-3 text-[10px] text-[#C7CACC] font-bold cursor-pointer">
          ...
          <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-right-4 w-[382px] mx-auto">
            <div className="relative w-full">
              <select 
                ...
                className="bg-[#F2F9FF] p-5 rounded-2xl text-[#9A67FF] font-black outline-none cursor-pointer w-full appearance-none pr-12"
              >
